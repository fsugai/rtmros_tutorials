...
class SampleRobotHrpsysConfigurator(HrpsysConfigurator):
    ...
    def init (self, robotname="KHR", url=""):
        HrpsysConfigurator.init(self, robotname, url)
        print "initialize rtc parameters"
        self.setStAbcParameters()

    def defJointGroups (self):
        rleg_6dof_group = ['rleg', ['RLEG_JOINT0', 'RLEG_JOINT1', 'RLEG_JOINT2', 'RLEG_JOINT3', 'RLEG_JOINT4']]
        lleg_6dof_group = ['lleg', ['LLEG_JOINT0', 'LLEG_JOINT1', 'LLEG_JOINT2', 'LLEG_JOINT3', 'LLEG_JOINT4']]
        torso_group = ['torso', ['CHEST_JOINT0']]
        head_group = ['head', ['HEAD_JOINT0']]
        rarm_group = ['rarm', ['RARM_JOINT0','RARM_JOINT1','RARM_JOINT2']]
        larm_group = ['larm', ['LARM_JOINT0','LARM_JOINT1','LARM_JOINT2']]
